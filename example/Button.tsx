...
// export interface BaseButtonProps extends AntdButtonProps {}
...
const ButtonTypes = tuple('default', 'primary', 'subtle', 'ghost', 'dashed', 'link', 'text');
...
const InternalButton: React.ForwardRefRenderFunction<unknown, ButtonProps> = (props, ref) => {
  ...
  // ===================== Disabled =====================
  const disabled = React.useContext(DisabledContext) as boolean;
